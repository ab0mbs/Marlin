...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kp_LIST {  37.49,  37.49 }
    #define DEFAULT_Ki_LIST {   4.46,   4.46 }
    #define DEFAULT_Kd_LIST {  78.73,  78.73 }
  #else
    #define DEFAULT_Kp  37.49
    #define DEFAULT_Ki   4.46
    #define DEFAULT_Kd  78.73
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 91.92
  #define DEFAULT_bedKi 15.53
  #define DEFAULT_bedKd 362.79
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 136.67 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -12, -1.76 }
